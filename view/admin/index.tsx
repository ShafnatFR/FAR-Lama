...
import { UserRole, UserData, FoodItem, ClaimHistoryItem, FAQItem, BroadcastMessage } from '../../types';
...
export const AdminIndex: React.FC<AdminIndexProps> = ({ 
  ...
  const renderContent = () => {
    switch (activeTab) {
      ...
      case 'distribution':
        return <Distribution claims={globalClaims} users={globalUsers} inventory={globalInventory} />;
      case 'impact':
