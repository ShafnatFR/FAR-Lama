...
import { VolunteerTask, RankLevel, DailyQuest, LeaderboardItem, ClaimHistoryItem, UserData, Address } from '../../types';
...
export const VolunteerIndex: React.FC<VolunteerIndexProps> = ({ 
  ...
  const mapClaimToTask = (claim: ClaimHistoryItem): VolunteerTask => {
      ...
      return {
          ...
          to: receiverAddressData ? receiverAddressData.receiverName : (claim.receiverName || 'Penerima Manfaat'), 
          distance: 2.5,
          distanceStr: '2.5 km',
          ...
          donorPhone: providerAddressData?.phone,
          receiverPhone: receiverAddressData?.phone || claim.receiverPhone,
          points: 150
      };
  };
  ...
  }, [activeClaims, userName, allAddresses]);
