            ...
            <div className="flex justify-between items-center mb-6">
                ...
                {onRefresh && (
                    <button
                        ...
                        className="ml-2 h-9 px-4 bg-stone-900 dark:bg-white text-white dark:text-stone-900 rounded-full flex items-center justify-center gap-2 text-[10px] font-black uppercase tracking-wider hover:scale-105 active:scale-95 transition-all shadow-md hover:shadow-lg shrink-0 disabled:opacity-50 disabled:cursor-not-allowed"
                    >
                        {showLoading ? <Loader2 className="w-3.5 h-3.5 animate-spin" /> : <RefreshCw className="w-3.5 h-3.5" />} Refresh
                    </button>
                )}
            </div>
