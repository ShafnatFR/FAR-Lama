...
import { User, MapPin, Shield, HelpCircle, LogOut, Moon, Sun, Store, Heart, ChevronRight, ArrowLeft } from 'lucide-react';
    ...
    if (currentView === 'history') {
        ...
        return (
            <div className="pb-32 bg-[#FDFBF7] dark:bg-stone-950 min-h-screen">
                <div className="px-6 pt-8 pb-2 md:px-8 bg-[#FDFBF7] dark:bg-stone-900 sticky top-0 z-10">
