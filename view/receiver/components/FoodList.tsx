        ...
        <div className="flex justify-between items-center gap-4">
            ...
            <div className="flex gap-2 shrink-0">
                {onRefresh && (
                    <button
                        onClick={onRefresh}
                        className="h-9 px-4 bg-stone-900 dark:bg-white text-white dark:text-stone-900 rounded-xl flex items-center justify-center gap-2 text-[10px] font-black uppercase tracking-wider hover:scale-105 active:scale-95 transition-all shadow-md hover:shadow-lg"
                    >
