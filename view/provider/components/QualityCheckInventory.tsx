                ...
                <div className="w-full max-w-3xl mx-auto py-8 space-y-8 pb-32 animate-in slide-in-from-bottom-12 duration-700">
                     ...
                     <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                        <div className="bg-white dark:bg-stone-900 p-6 rounded-[2rem] border border-stone-200 dark:border-stone-800 shadow-sm">
                            <h4 className="font-black text-xs text-stone-900 dark:text-white uppercase mb-3 flex items-center gap-2"><AlertTriangle className="w-4 h-4 text-red-500" /> Peringatan Alergen</h4>
                            <div className="flex flex-wrap gap-2">
                                {(analysisResult.allergens?.length > 0 ? analysisResult.allergens : ['TELUR', 'SANTAN']).map((alg: string, i: number) => (
