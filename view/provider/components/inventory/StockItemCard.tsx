            ...
            <div className="flex-1 flex flex-col justify-between">
                <div>
                    <div className="flex justify-between items-start mb-1">
                        ...
                        <span className={`text-[8px] md:text-[10px] font-black px-1.5 py-0.5 md:px-2 md:py-1 rounded-lg uppercase tracking-widest shrink-0 ml-2 ${item.currentQuantity > 0 ? 'bg-green-50 text-green-600' : 'bg-red-50 text-red-600'}`}>
                            {item.currentQuantity > 0 ? 'Aktif' : 'Habis'}
                        </span>
                    </div>
